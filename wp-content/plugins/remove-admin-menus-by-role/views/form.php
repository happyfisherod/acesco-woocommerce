...
<form action="" method="post" id="hide_menu_admin_form">
	...
	<div class="column">
		<strong><?php _e('For these roles:', 'remove-admin-menus-by-roles'); ?></strong>
		<ul>
		<?php
	...
	<div class="column">
		<strong><?php _e('Remove these menus:', 'remove-admin-menus-by-roles'); ?></strong><br />
		<a href="#" class="select_all_menu"><?php _e('Select all', 'remove-admin-menus-by-roles'); ?></a> <a href="#" class="deselect_all_menus"><?php _e('Deselect all', 'remove-admin-menus-by-roles');?></a>
		<ul class="menus">
<?php
...
<input type="submit" value="<?php _e('Save profile', 'remove-admin-menus-by-roles'); ?>" />
</form>

<p>
	<?php _e('You need multiple profiles? Look at', 'remove-admin-menus-by-roles'); ?> <a href="https://www.info-d-74.com/produit/remove-admin-menus-by-role-pro-plugin-wordpress/" target="_blank"><?php _e('Pro version', 'remove-admin-menus-by-roles'); ?> <a href="https://www.facebook.com/infod74/" target="_blank"><img src="<?php echo plugins_url( 'images/fb.png', dirname(__FILE__)) ?>" alt="" /></a><br />
	<a href="https://www.info-d-74.com/produit/remove-admin-menus-by-role-pro-plugin-wordpress/" target="_blank">
