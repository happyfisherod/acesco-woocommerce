...
<?php if( !(defined('URNA_WOOCOMMERCE_CATALOG_MODE_ACTIVED') && URNA_WOOCOMMERCE_CATALOG_MODE_ACTIVED) ) : ?>
	...
	<div class="tbay-login">
		...
		<?php if (is_user_logged_in() ) { ?>
			...
			?>
			<a class="account-button" href="javascript:void(0);"><i class="linear-icon-user"></i><span class="hidden-xs"><?php esc_html_e('Mi cuenta'); ?></span></a>
			...
			<?php
				...
				if($user_roles[0] == 'seller'){
					if( isset($menu_after_login) && $menu_after_login ) : ?>
