...
if ( !function_exists('urna_ajax_auth_init') ) {
    function urna_ajax_auth_init(){  
        ...
        wp_register_script( 'jquery-validate', URNA_SCRIPTS . '/jquery.validate.js', array( 'jquery' ), '1.0', true );
        wp_register_script( 'urna-auth-script', URNA_SCRIPTS . '/ajax-auth-script.js', array( 'jquery-validate' ), '1.0', true );
...
if ( !function_exists('urna_ajax_register') ) { 
    function urna_ajax_register(){
        ...
        if ( is_wp_error($user_register) ){ 
            ...
            update_field('terminos_y_condiciones_aceptados', true, 'user_'.$user_register);
