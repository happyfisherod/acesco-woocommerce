    ...
    <div class="header-main">
        <div class="container">
            <div class="row">
				...
				<div class="header-search col-lg-5 col-md-5">
				...
				<div class="header-main-right col-lg-3 col-md-3">
				...
				<div class="header-logo col-lg-2 col-md-2"> 
					<div class="logo-link">
						<a href="https://www.acesco.com.co/" target="_blank"><img src="https://construyamos.com/colombia/wp-content/uploads/2020/07/logo-acesco-header.png" alt="" width="100%"></a>
					</div>
    ...
    <div class="header-mainmenu">
        <div class="container">
	        <div class="row">
			    ...
			    <div class="tbay-mainmenu col-lg-8 col-md-5">
					<?php urna_tbay_get_page_templates_parts('nav'); ?>
			    </div>
			    
			    <div class="header-right recent-view col-lg-2 col-md-5">
