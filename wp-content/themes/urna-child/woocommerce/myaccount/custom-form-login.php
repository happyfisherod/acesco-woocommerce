                ...
                <div class="tab-content clearfix">
                    ...
                    <div id="tab-customregister" class="tab-pane fade">
                        <form id="custom-register" class="ajax-auth"  action="register" method="post">
                            ...
                            <input type="password" id="password2" placeholder="<?php esc_attr_e('Confirm Password', 'urna'); ?>" class="required" name="password2" 
                            autocomplete="new-password">
                            <div class="terms" style="clear:both; overflow: hidden;"> 
                                <label for="gdpr" class="checkbox-container"> He leído y acepto los <a href="https://construyamos.com/colombia/terminos-y-condiciones/" target="_blank">Términos y Condiciones</a>  y <a href="https://construyamos.com/colombia/aviso-de-privacidad/" target="_blank">Políticas de Privacidad</a>
