		...
		<div class="mcart-border">
							...
							<li id="mcitem-<?php echo esc_attr($_id);?>-<?php echo esc_attr($cart_item_key); ?>">
								...
								<div class="product-details">
									...
									<?php echo apply_filters( 'woocommerce_cart_item_remove_link', sprintf(
									    '<a href="%s" class="remove_from_cart_button" aria-label="%s" data-product_id="%s" data-product_sku="%s" data-cart_item_key="%s"><i class="linear-icon-trash2"></i></a>',
			...
			<?php else: ?>
				...
				<div class="group-button">
					<p>Tu Carrito está vacío, selecciona los productos disponibles de tu distribuidor más cercano y agrégalos al carro.</p> 
					<p>&nbsp;</p>
					<p class="buttons">
						<a href="<?php echo get_site_url(); ?>/carro-2/" class="button checkout cart-button-popup">Mis productos</a>
						<a href="<?php echo esc_url( apply_filters( 'woocommerce_return_to_shop_redirect', wc_get_page_permalink( 'shop' ) ) ); ?>" class="button view-cart cart-button-popup"><?php esc_html_e( 'Continue Shopping', 'urna' ) ?></a>
			...
			<?php if(sizeof(WC()->cart->get_cart()) > 0) : ?>
				<div class="group-button">
					...
					<p class="buttons">
						<a href="<?php echo get_site_url(); ?>/carro-2/" class="button checkout cart-button-popup">Mis productos</a>
						<a href="<?php echo esc_url( wc_get_cart_url() ); ?>" class="button view-cart cart-button-popup"><?php esc_html_e('View Cart', 'urna'); ?></a>
