                    ...
                    <ul class="dokan-store-info">
                        ...
                        <?php if ( ! dokan_is_vendor_info_hidden( 'phone' ) && ! empty( $store_user->get_phone() ) ) { ?>
                            <li class="dokan-store-phone">
                                ...
                                <a href="http://wa.me/<?php echo esc_html( $store_user->get_phone() ); ?>" target="_blank"><?php echo esc_html( $store_user->get_phone() ); ?></a>
                            </li>
                        <?php } ?>
    ...
    <div class="dokan-store-tabs<?php echo esc_attr( $no_banner_class_tabs ); ?>">
        <ul class="dokan-list-inline">
            <?php foreach( $store_tabs as $key => $tab ) { 
                if($tab['title'] == 'Productos' || $tab['title'] == 'Reseñas' || $tab['title'] == 'Opiniones'){?>
                <?php }else{ ?>
