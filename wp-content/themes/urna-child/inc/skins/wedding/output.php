...
$output['secondary-font'] = array('.tbay-homepage-demo .site-main .tbay-addon .tbay-addon-title > span:not(.subtitle), .tbay-homepage-demo .site-main .tbay-addon .tbay-addon-heading > span:not(.subtitle)');
